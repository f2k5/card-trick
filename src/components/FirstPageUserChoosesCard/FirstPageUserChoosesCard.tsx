...
const FirstPageUserChoosesCard : React.FC = () => {
    ...
    return (
        <FullAppContainer>
            <div>
                <Header>
                    <Typography style={{color:"#e3f2fd"}} variant = "h4">Here are a few cards, choose one and keep it in your mind.</Typography>
                </Header>
                ...
                <Button variant = "contained" onClick = {handleClickTotakeUserToPageTwo}> Click here when you've chosen a card.</Button>
